# FastSpeech 2 - CWT version

This is a modification of Microsoft's text-to-speech system [**FastSpeech 2: Fast and High-Quality End-to-End Text to Speech**](https://arxiv.org/abs/2006.04558v1). 
...
This code is modified from [ming024's implementation](https://ming024.github.io/FastSpeech2)
![](./img/model.png)

# Updates
- Adding a CWT module to extract more feature

# Audio Samples
Audio samples generated by this implementation can be found [here](https://ming024.github.io/FastSpeech2/). 

# EX
You need download hifigan module from [here](https://ming024.github.io/FastSpeech2/hifigan) and put it under the main dir.
# Quickstart 
